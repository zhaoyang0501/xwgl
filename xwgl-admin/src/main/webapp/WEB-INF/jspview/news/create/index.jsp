													...
													<div>
														<div class="container-fluid">
															<div id="thelist1" class="row ">
																...
																<c:if test="${news.img!=null }">
																	<div class="file-item thumbnail">
																		<input type="hidden" name="img" value="${news.img}" />
																				<img src="${pageContext.request.contextPath}/${news.img }">
																	</div>
																</c:if>
																...
																<c:if test="${news.img==null }">
																	<div class="file-item thumbnail">
																		<input type="hidden" name="img" value="img/newsdefault.jpg" />
																					<img src="${pageContext.request.contextPath}/img/newsdefault.jpg">
																					<p class="state">默认图片</p>
																	</div>
																</c:if>
