    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="ibox">
                    <div class="ibox-content">
                        <h5 class="m-b-md">电子书今日阅读</h5>
                        <h2 class="text-navy">
                                    <i class="fa fa-play fa-rotate-270"></i> 4次上升
                                </h2>
                        <small>更新时间：5分钟前</small>
                    </div>
                </div>
            ...
            <div class="col-sm-3">
                <div class="ibox">
                    <div class="ibox-content ">
                        <h5 class="m-b-md">电子书本月</h5>
                        <h2 class="text-navy">
                                    <i class="fa fa-play fa-rotate-270"></i> 43次上升
                                </h2>
                        <small>更新时间：5分钟前</small>
                    </div>
                </div>
